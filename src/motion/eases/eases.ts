...
export const standardEases: EaseDeclaration[] = [
  ...
  // Sine
  { name: 'sine.in', ease: 'sine.in', bezier: [0.12, 0, 0.39, 0], description: '' },
  { name: 'sine.out', ease: 'sine.out', bezier: [0.61, 1, 0.88, 1], description: '' },
  { name: 'sine.inOut', ease: 'sine.inOut', bezier: [0.37, 0, 0.63, 1], description: '' },
  // ?
  { name: 'power1.in', ease: 'power1.in', bezier: [0.426, -0.015, 0.75, 0.529], description: '' },
  { name: 'power1.out', ease: 'power1.out', bezier: [0.356, 0.716, 0.693, 0.99], description: '' },
  { name: 'power1.inOut', ease: 'power1.inOut', bezier: [0.459, 0.013, 0.536, 0.973], description: '' },
  // Cubic
  { name: 'power2.in', ease: 'power2.in', bezier: [0.32, 0, 0.67, 0], description: '' },
  { name: 'power2.out', ease: 'power2.out', bezier: [0.33, 1, 0.68, 1], description: '' },
  { name: 'power2.inOut', ease: 'power2.inOut', bezier: [0.65, 0, 0.35, 1], description: '' },
  // Quad
  { name: 'power3.in', ease: 'power3.in', bezier: [0.5, 0, 0.75, 0], description: '' },
  { name: 'power3.out', ease: 'power3.out', bezier: [0.25, 1, 0.5, 1], description: '' },
  { name: 'power3.inOut', ease: 'power3.inOut', bezier: [0.76, 0, 0.24, 1], description: '' },
  // Quint / Strong
  { name: 'power4.in', ease: 'power4.in', bezier: [0.64, 0, 0.78, 0], description: '' },
  { name: 'power4.out', ease: 'power4.out', bezier: [0.22, 1, 0.36, 1], description: '' },
  { name: 'power4.inOut', ease: 'power4.inOut', bezier: [0.83, 0, 0.17, 1], description: '' },
  // Expo
  { name: 'expo.in', ease: 'expo.in', bezier: [0.7, 0, 0.84, 0], description: '' },
  { name: 'expo.out', ease: 'expo.out', bezier: [0.16, 1, 0.3, 1], description: '' },
  { name: 'expo.inOut', ease: 'expo.inOut', bezier: [0.87, 0, 0.13, 1], description: '' },
  // Circ
  { name: 'circ.in', ease: 'circ.in', bezier: [0.55, 0, 1, 0.45], description: '' },
  { name: 'circ.out', ease: 'circ.out', bezier: [0, 0.55, 0.45, 1], description: '' },
  { name: 'circ.inOut', ease: 'circ.inOut', bezier: [0.85, 0, 0.15, 1], description: '' },
  // Back
  { name: 'back.in', ease: 'back.in', bezier: [0.36, 0, 0.66, -0.56], description: '' },
  { name: 'back.out', ease: 'back.out', bezier: [0.34, 1.56, 0.64, 1], description: '' },
  { name: 'back.inOut', ease: 'back.inOut', bezier: [0.68, -0.4, 0.32, 1.4], description: '' },
  // Elastic
  { name: 'elastic.in', ease: 'elastic.in', bezier: [1, -0.1, 0.896, -0.147], description: '' },
  { name: 'elastic.out', ease: 'elastic.out', bezier: [0, 1.25, 0.103, 1.073], description: '' },
  { name: 'elastic.inOut', ease: 'elastic.inOut', bezier: [0.973, -0.25, 0.025, 1.25], description: '' },
  // Bounce
  { name: 'bounce.in', ease: 'bounce.in', bezier: [1, 0, 0.6, 0.8], description: '' },
  { name: 'bounce.out', ease: 'bounce.out', bezier: [0.28, 0.02, 0, 1], description: '' },
  { name: 'bounce.inOut', ease: 'bounce.inOut', bezier: [0.78, 0, 0.2, 1], description: '' }
]
