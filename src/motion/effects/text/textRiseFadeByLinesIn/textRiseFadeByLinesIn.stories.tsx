...
import textRiseFadeByLinesIn from './textRiseFadeByLinesIn'

export default { title: 'motion/Effects/text/textRiseFadeByLinesIn' }

gsap.registerEffect(textRiseFadeByLinesIn)
...
export const Default: StoryFn = ({ content, ...args }) => {
  ...
  useEffect(() => {
    ...
    if (el) timeline.textRiseFadeByLinesIn(el!, args, 0.4)
    return () => {
      timeline.kill()
...
Default.args = {
  ...textRiseFadeByLinesIn.defaults,
  duration: 1,
